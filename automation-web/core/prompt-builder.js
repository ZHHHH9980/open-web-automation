...
function buildPlannerPrompt(task, step, maxSteps, state, history, possibleLoginDetected) {
  ...
  promptLines.push(
    ...
    "   ",
    "   BEST PRACTICE: Use type action with press_enter parameter:",
    ...
    "   Step 1: {\"action\": \"type\", \"target_id\": 5, \"text\": \"query\", \"reason\": \"...\"}",
    "   Step 2: {\"action\": \"press\", \"key\": \"Enter\", \"reason\": \"Submit search\"}",
    "   ",
